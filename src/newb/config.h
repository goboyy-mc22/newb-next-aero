...
#define NL_TINT_LOW  vec3(1.0,1.0,1.1) // color tint for dark tone
...
/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.00,0.55,0.35)
#define NL_UNDERWATER_TORCH_COL vec3(1.00,0.55,0.35)
#define NL_NETHER_TORCH_COL     vec3(1.00,0.55,0.35)
#define NL_END_TORCH_COL        vec3(1.00,0.55,0.35)
...
/* Sky */
#define NL_SKY_VOID_FACTOR     0.38
#define NL_SKY_VOID_DARKNESS   0.18
...
#define NL_RAIN_ZENITH_COL   vec3(0.54,0.64,0.76)
#define NL_RAIN_HORIZON_COL  vec3(0.76,0.86,0.94)
...
#define NL_RAINBOW_CLEAR 0.12 // 0.3 subtle ~ 1.0 bright during clear weather
#define NL_RAINBOW_RAIN  0.56 // 0.3 subtle ~ 1.0 bright during rain weather
...
#define NL_WAVE_SPEED 2.10      // 0.5 slow wave ~ 5.0 very fast wave
...
#define NL_WATER_TINT vec3(0.0,0.08,0.12)
...
/* Soft cloud settings */
#define NL_CLOUD1_SCALE vec2(0.012, 0.017) // 0.003 large ~ 0.2 tiny
#define NL_CLOUD1_DEPTH 1.05                // 0.0 no bump ~ 10.0 large bumps
#define NL_CLOUD1_SPEED 0.028               // 0.0 static ~ 0.4 fast moving
#define NL_CLOUD1_DENSITY 0.8             // 0.1 less clouds ~ 0.8 more clouds
#define NL_CLOUD1_OPACITY 0.9              // 0.0 invisible ~ 1.0 opaque

/* Rounded cloud settings */
#define NL_CLOUD2_THICKNESS 4.4            // 0.5 slim ~ 5.0 fat
...
#define NL_ENTITY_EDGE_HIGHLIGHT 0.6 // [toggle] 0.0 no highlight ~ 1.6 bright highlight
...
#define NL_LAVA_NOISE_BUMP 0.14 // [toggle] 0.1 subtle ~ 0.8 massive waves
