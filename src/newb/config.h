...
#define NL_UNDERWATER_TORCH_COL vec3(1.00,0.55,0.20)
#define NL_NETHER_TORCH_COL     vec3(1.00,0.55,0.20)
...
#define NL_WATER_BUMP 0.035        // 0.001 plain ~ 0.2 bumpy water
