...
#endif
$output v_color0, v_color1, v_fog, v_refl, v_texcoord0, v_lightmapUV, v_extra, v_cpos, v_wpos
...
void main() {
  ...
  nl_environment env = nlDetectEnvironment(DimensionID, TimeOfDay.x, 0.0, FogColor.rgb, FogAndDistanceControl.xyz);
